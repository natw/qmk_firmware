...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
     ...
     KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_ESC,                   CW_TOGG,  KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                          KC_LOPT, KC_SPC,  KC_LGUI, LY_SYM,  LY_NAV, KC_ENTER, KC_LALT, KC_MINUS
    ),
    /*[_NAV] = LAYOUT(*/
    ...
    [_SYM_NUM] = LAYOUT(
     ...
     _______, KC_PERCENT, KC_CARET,  KC_LBRC,   KC_RBRC,   _______,  ALT_GR,                 KC_APP,  KC_MUTE, KC_1, KC_2, KC_3, _______, KC_RCTL,
                                     _______,   _______,   _______,  _______,  KC_BACKSLASH, _______, _______, KC_0 
    ),
    [_NAV] = LAYOUT(
     _______, _______, _______, _______, _______, _______,                                          KC_PGUP, _______, _______, _______,  KC_BRIU, KC_VOLU, 
     _______, _______, _______, _______, _______, _______,                                          KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_BRID, KC_VOLD, 
     _______, _______, _______, _______, _______, _______, _______,                        _______, KC_PGUP, KC_MPRV, PLY_PAU, KC_MNXT,  _______, _______,
